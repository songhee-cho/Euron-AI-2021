...
Original file is located at
    https://colab.research.google.com/drive/1HaiKJD3kxEyvHCtCDz1vXiSDdVPXKFR8
"""
...
For RNNs in word units, the vocabulary can be large, and each output can at least be guaranteed to be a meaningful word; while for RNNs in letters, the vocabulary is a fixed size, but the output range is almost infinite, And there is no guarantee that the output combination is a meaningful word. Therefore, the effect of one-letter RNN should not be as good as one-word RNN.
