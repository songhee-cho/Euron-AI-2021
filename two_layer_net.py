...
Original file is located at
    https://colab.research.google.com/drive/1Kfy-Nd0m9zfynTmGbxWA4eOPmRu_d5X1
"""
...
for i in range(20):
    ...
    print('lr %e reg %e hidden %d train_accuracy %f val_accuracy %f'%(learning_rates, regs, hidden_sizes, train_acc, val_acc))
...
$\color{blue}{\textit Your Explanation:}$ If your testing accuracy is much lower than the training accuracy, it means your model is overfitting. So you have to make your dataset larger or increase the regularization strength. Increasing the regularization strength makes model less complex and flexible.
